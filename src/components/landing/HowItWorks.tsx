...
function HowItWorks() {
  return (
    <section className="relative py-16 md:py-24 px-4 sm:px-6 z-10 max-w-7xl mx-auto">
      {/* HEADER */}
        ...
        <div className="grid gap-10 lg:grid-cols-3 lg:gap-8">
          {[
            ...
            <div key={item.step} className="relative group">
              <div className="relative bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 transition-all duration-300 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/10">
                {/* Step Number */}
                ...
                {/* Icon */}
                <div className="w-20 h-20 bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl flex items-center justify-center mx-auto mb-6 transition-transform duration-300 group-hover:scale-110">
                  <Image
                    src={item.img}
                    alt={item.title}
                    width={40}
